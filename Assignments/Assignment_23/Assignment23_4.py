...
def main():
    ...
    print("X - Independent  ", X.shape) # (30,5)   # Feature 
    print("Y - Dependent ",Y.shape)  # (30,)   # label
    ...
    ConfusionM = confusion_matrix(Y_pred,Y_test)
    print(ConfusionM)   # [[5 0] [[TP,FP]]
                        # [0 1]] [[FN,TN]]
                    
    
    # print("------------------------------ Confusion MAtrix Plot -------------------------")
    # Data = ConfusionMatrixDisplay(confusion_matrix= ConfusionM,display_labels= model.classes_)
