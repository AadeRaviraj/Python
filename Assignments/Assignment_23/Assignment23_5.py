...
def main():
    ...
    Y_trainPred=modelObj.predict(X_train)    
    Y_testPred = modelObj.predict(X_test)
    
    
    print("-------------------------------- Training Accuracy Result ----------------------------")
    trainingAccuracy = accuracy_score(Y_train,Y_trainPred)
    print(trainingAccuracy)
    
    print("-------------------------------- Testing Accuracy Result ----------------------------")
    testingAccuracy = accuracy_score(Y_test,Y_testPred)
